...
import { FunctionDeclaration, FunctionExpression, ObjectMethod, ArrowFunctionExpression } from '@babel/types';
...
export type ExplicitWorklet = FunctionDeclaration | FunctionExpression | ArrowFunctionExpression;
