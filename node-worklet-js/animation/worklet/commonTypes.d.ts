...
export interface AnimationObject {
    ...
    onStart: (nextAnimation: any, current: any, timestamp: number, previousAnimation: any) => void;
}
export interface Animation<T extends AnimationObject> extends AnimationObject {
    onFrame: (animation: T, timestamp: number) => boolean;
    onStart: (nextAnimation: T, current: AnimatableValue, timestamp: number, previousAnimation: Animation<any> | null | T) => void;
}
